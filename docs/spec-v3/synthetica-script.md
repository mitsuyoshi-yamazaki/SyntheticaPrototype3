...
- **0xA0-0xA7: UNIT_READ** - 外部ユニット情報読み取り
  - 第2バイト: ユニット種別
  - 第3バイト: 読み取りパラメータ
  - Dレジスタ: 同種ユニットのインデックス（0から開始）
  - 結果: Aレジスタに格納
- **0xA8-0xAF: UNIT_CMD** - 外部ユニットへコマンド送信
  - 第2バイト: ユニット種別
  - 第3バイト: コマンド種別
  - Dレジスタ: 同種ユニットのインデックス
  - Aレジスタの値をパラメータとして使用
...
- **0xB0-0xB7: LOAD_ABS** - A = Memory[第2バイト] （絶対アドレス指定）
- **0xB8-0xBF: STORE_ABS** - Memory[第2バイト] = A （絶対アドレス指定）
