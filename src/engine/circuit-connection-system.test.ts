  ...
  describe("回路接続チェック", () => {
    ...
    beforeEach(() => {
      hull1 = {
        ...
        capacity: 100,
        storedEnergy: 0,
        attachedUnitIds: [2, 3] as ObjectId[],
      }
  ...
  describe("回路再構成", () => {
    test("HULL分離時の回路再構成", () => {
      const hull: Hull = {
        ...
        capacity: 100,
        storedEnergy: 0,
        attachedUnitIds: [2, 3, 4, 5] as ObjectId[],
      }
    ...
    test("HULL統合時の回路結合", () => {
      ...
      const hull2: Hull = {
        ...
        capacity: 100,
        storedEnergy: 0,
        attachedUnitIds: [11, 12] as ObjectId[],
      }
  ...
  describe("デバッグ機能", () => {
    test("回路接続状態の文字列表現", () => {
      const hull: Hull = {
        ...
        capacity: 100,
        storedEnergy: 0,
        attachedUnitIds: [2, 3, 4] as ObjectId[],
      }
