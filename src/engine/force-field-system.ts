...
export class ForceFieldSystem {
   ...
   */
  public calculateForceFromField(
    position: Vec2,
    ...
    switch (field.type) {
      case "LINEAR": {
        // 線形力場: 一定方向の力
        force = field.direction !== undefined ? Vec2Utils.copy(field.direction) : Vec2Utils.create(0, 0)
        break
      }
