...
export class EnergySystem {
   ...
   * @returns 結合結果
   */
  public combineEnergyObjects(objects: EnergyObject[], newId: ObjectId): EnergyCombineResult {
    if (objects.length < 2) {
    ...
    // 質量中心を計算
    const centerOfMass = Vec2Utils.create(centerX / totalMass, centerY / totalMass)
   ...
   */
  public findCombineCandidates(energyObjects: Map<ObjectId, EnergyObject>): EnergyObject[][] {
