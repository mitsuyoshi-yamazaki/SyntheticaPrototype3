...
const generateSelfReplicatorProgram = (): Uint8Array => {
  ...
  const fixups: Record<string, number[]> = {}
  ...
  units: [
    {
      ...
      parameters: {
        type: "HULL",
        capacity: SELF_REPLICATION_CONSTANTS.REPRODUCTION_CAPACITY,
      },
    ...
    },
    {
      ...
      parameters: {
        type: "ASSEMBLER",
        assemblePower: SELF_REPLICATION_CONSTANTS.CHILD_ASSEMBLER_POWER,
      },
    ...
    },
    {
      ...
      parameters: {
        type: "COMPUTER",
        processingPower: SELF_REPLICATION_CONSTANTS.CHILD_COMPUTER_FREQ,
        memorySize: SELF_REPLICATION_CONSTANTS.CHILD_COMPUTER_MEMORY,
      },
      isAttached: true, // HULLに接続
    },
  ],
